...
from .aux.iah_filter import iah_filter_ppi, iah_filter_rhi
from .aux.rh_filter import rh_filter
...
def filters(radar_config_file, date, met_path):
    ...
    total_filter = d.createVariable("iah_and_rh_filter", 'i8', ("arr_len",))
    iah_fil = d.createVariable("iah_filter", 'i8', ("arr_len",))
    rh_fil = d.createVariable("rh_filter", 'i8', ("arr_len",))
    rh_value = d.createVariable("rh_value", 'f4', ("arr_len",))
    #datetime = d.createVariable("datetime", 'S1', ("arr_len",))
