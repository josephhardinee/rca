...
def test_create_az_mask_ppi_handles_0_and_360():
    ...
    assert  ret_value[2] == False or ret_value[3] == False, 'Improper azimuths set to true'
    assert  ret_value[3] == True or ret_value[4] == True or ret_value[5] == True, 'Mishandling of azimuths near 360.'
