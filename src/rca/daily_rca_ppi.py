...
if __name__ == "__main__":
    ...
    csvdir = sys.argv[9]
    print(datadir, site, inst, date, cluttermapdir, baselinedir, baseline_date, clutter_date, csvdir)
    ...
    dataset = Dataset(cluttermapdir+'cluttermap_ppi_'+site+inst+'_'+clutter_date+'.nc')
    ...
    if inst == 'kasacr':
        ...
        rca_dict = {
            "DATE": date, "RCA_H": rca_h, "RCA_V": rca_v, "BASELINE": base}#, "RCA_H_93": rca_h_93, "RCA_H_97": rca_h_97
       # }
        csv_frame = csv_frame.append(rca_dict, ignore_index=True)
        csv_frame.set_index('DATE')
        csv_frame.to_csv(csv_filepath , index=False)
