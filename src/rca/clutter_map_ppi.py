...
if __name__ == "__main__":
    ...
    if inst == "kasacr":
        ...
        for f in glob.glob(os.path.join(datadir, "*kasacr*" + date + "*.??")):
            print(f)
            DateTime, ClutterFlagH = create_clutter_flag_ppi(
        ...
        dataset = Dataset(
            cluttermapdir + "cluttermap_ppi_" + site + inst + "_" + date + ".nc",
            "w",
        ...
        if inst == "xsapr2":
            ...
            for f in glob.glob(
                ...
                print(f)
                DateTime, ClutterFlagH, ClutterFlagV = create_clutter_flag_ppi(
                    f, inst, range_limit, range_shape, z_thresh
                )
