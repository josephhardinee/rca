...
def hourly_rca(radar_config_file, date):
    """
...
directory, scan type, polarization, site, instrument, range limit
    ...
    hourly_csv_fullpath = (dailycsvdir + "hourly_rca_" + scantype + "_" + site + inst + "_" + date + "_strictaz_numps.csv")
    ...
    if polarization == "horizontal":
        ...
        # Calculate RCA
            ...
            rca_dict = {"DATE": dt, "RCA_H": rca_h, "RCA_V":np.nan,"NUM_PTS":s_h['num_points']}
